...
async function init() {
    ...
    // --- ĐOẠN CODE ÉP QUYỀN ADMIN (DÙNG ĐỂ VƯỢT RÀO VÀO DUYỆT TÀI KHOẢN) ---
    if (session.user.email === 'vuhuythanh271092@gmail.com' || session.user.email === 'vuhuythanhtd3979@gmail.com') {
